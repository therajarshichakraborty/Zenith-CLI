    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="flex w-full max-w-[380px] flex-col items-center text-center">
        ...
        <div className="w-full space-y-2.5 mb-5">
          <button className="mb-6 flex w-full items-center justify-center gap-2 rounded-lg border border-border py-[10px] text-sm font-medium text-foreground transition-colors hover:bg-muted dark:bg-white dark:text-black bg-black text-white">
